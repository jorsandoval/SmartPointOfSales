...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.CreateModel(
            name='MedioPago',
            fields=[
                ('id_medio_pago', models.IntegerField(primary_key=True, serialize=False, verbose_name='Identificador del medio de pago')),
        ...
        migrations.CreateModel(
            name='Venta',
            fields=[
                ('id_venta', models.IntegerField(primary_key=True, serialize=False, verbose_name='Identificador de la venta')),
        ...
        migrations.CreateModel(
            name='DetalleVenta',
            fields=[
                ('id_detalle_venta', models.IntegerField(primary_key=True, serialize=False, verbose_name='Identificador del detalle de venta')),
