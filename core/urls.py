...
from .views import form_mod_producto, home, home_cliente, home_detalle_venta, home_medio_pago, home_producto, home_venta, form_cliente, form_venta, form_producto, form_medio_pago, form_detalle_venta, form_mod_cliente, form_mod_producto, form_mod_medio_pago, form_mod_venta, form_del_cliente, form_del_producto, form_del_venta, form_del_medio_pago
...
urlpatterns = [
    ...
    #Formularios para listar y acceder a los mantenedores
